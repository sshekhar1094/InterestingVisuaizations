...
'''
    ...
    Plots Supported: bar graphs (vertical n horizontal), multi line graph, scatter plot, pie chart, bollinger band,
        histogram, box plot.
'''
...
def scatter_plot(X, Y, xlabel='', ylabel='', title='', height=3):
    ...
    plot = Scatter(df, 'X', 'Y', title=title, plot_height=int(height*ht))
    plot.xaxis.axis_label = xlabel
    plot.yaxis.axis_label = ylabel
